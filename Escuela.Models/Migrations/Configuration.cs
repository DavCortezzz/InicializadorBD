...
=======
            context.Usuarios.AddOrUpdate(u => u.Correo,
                new Usuario { UsuarioId = 1, Nombre = "Admin Dirección", Correo = "admin@escuela.com", Contrasena = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", TipoUsuario = "Direccion", FechaExpiracionCodigo = DateTime.Now },
                new Usuario { UsuarioId = 2, Nombre = "Example", Correo = "ray@example.com", Contrasena = "d07164a628596323ebcf8796dee0e5c164620e0922b52483bc805f54416ee73c", TipoUsuario = "Direccion", FechaExpiracionCodigo = DateTime.Now },
                new Usuario { UsuarioId = 3, Nombre = "Prof. Newton", Correo = "newton@escuela.com", Contrasena = "790fad4744a9da8d301e23c83b386f1baabd229611dbe5265df62a97b5357393", TipoUsuario = "Profesor", FechaExpiracionCodigo = DateTime.Now }
            );

            context.SaveChanges();

            context.Grupos.AddOrUpdate(g => g.GrupoId,
                new Grupo { GrupoId = 1, Grado = "1roA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 2, Grado = "1roB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 3, Grado = "2doA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 4, Grado = "2doB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 5, Grado = "3roA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 6, Grado = "3roB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 7, Grado = "4toA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 8, Grado = "4toB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 9, Grado = "5toA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 10, Grado = "5toB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 11, Grado = "6toA", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 },
                new Grupo { GrupoId = 12, Grado = "6toB", Turno = "Matutino", CicloEscolar = "2025-2026", UsuarioId = 3 }
            );

            context.SaveChanges();
            context.Asignaturas.AddOrUpdate(a => a.AsignaturaId,
                new Asignatura { AsignaturaId = 1, Nombre = "Física I", UsuarioId = 3, GrupoId = 1 },
                new Asignatura { AsignaturaId = 2, Nombre = "Matemáticas II", UsuarioId = 3, GrupoId = 2 }
            );
